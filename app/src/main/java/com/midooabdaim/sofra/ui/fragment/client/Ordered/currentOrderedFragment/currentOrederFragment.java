package com.midooabdaim.sofra.ui.fragment.client.Ordered.currentOrderedFragment;
 ...
 */
public class currentOrederFragment extends BaseFragment {
    FragmentOrederdRecyclerBinding currentOrderedBinding;

    public currentOrederFragment() {

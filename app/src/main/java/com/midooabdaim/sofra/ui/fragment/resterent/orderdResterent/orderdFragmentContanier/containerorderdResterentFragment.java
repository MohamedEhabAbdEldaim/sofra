package com.midooabdaim.sofra.ui.fragment.resterent.orderdResterent.orderdFragmentContanier;
 ...
 */
public class containerorderdResterentFragment extends BaseFragment {
    FragmentOrederContainerBinding orederContainerBinding;
    ViewPagerWithFragmentAdapter vpadapter;

    public containerorderdResterentFragment() {

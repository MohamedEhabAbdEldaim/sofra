package com.midooabdaim.sofra.ui.fragment.client.Ordered.oldOrderedFragment;
 ...
 */
public class oldOrderedFragment extends BaseFragment {
    FragmentOrederdRecyclerBinding oldOrderedBinding;

    public oldOrderedFragment() {

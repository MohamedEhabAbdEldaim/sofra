...
package com.midooabdaim.sofra.data.model.Resterent.loginResterent;
...
public class User {
    ...
    @Expose
    private cityAndRegionData region;
    ...
    public cityAndRegionData getRegion() {
        return region;
    }

    public void setRegion(cityAndRegionData region) {
        this.region = region;
    }
